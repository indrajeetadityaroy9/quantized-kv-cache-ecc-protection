...
// Encodes INT4 triplets with Golay, remainder with Hamming
void reshape_and_cache_golay_hybrid(torch::Tensor& key, torch::Tensor& value,
                                    torch::Tensor& key_cache,
                                    torch::Tensor& value_cache,
                                    torch::Tensor& slot_mapping,
...
// ECC fault injection for testing error correction capabilities
// Injects random bit errors into INT4-ECC protected KV cache at specified BER
void inject_cache_errors(
    torch::Tensor& key_cache,    // uint8 ECC-encoded cache [num_blocks, ...]
    torch::Tensor& value_cache,  // uint8 ECC-encoded cache [num_blocks, ...]
    double bit_error_rate,       // probability of flipping each bit
