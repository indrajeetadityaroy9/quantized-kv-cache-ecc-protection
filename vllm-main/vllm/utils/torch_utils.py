...
STR_DTYPE_TO_TORCH_DTYPE = {
    ...
    "int4_ecc": torch.uint8,           # Hamming(8,4) SECDED uses uint8 codewords
    "int4_h74": torch.uint8,           # Hamming(7,4) SEC uses uint8 codewords
    "int4_golay": torch.int32,         # Golay(24,12) uses int32 codewords
    "int4_golay_hybrid": torch.uint8,  # Hybrid uses uint8 packed buffer
}
