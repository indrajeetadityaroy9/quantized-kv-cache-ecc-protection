...
class AttentionBackend(ABC):
    ...
    supported_kv_cache_dtypes: ClassVar[list["CacheDType"]] = [
        "auto",
        # ECC-protected INT4 cache types (integrated in paged attention kernels)
        "int4_ecc",           # INT4 + Hamming(8,4) SECDED
        "int4_h74",           # INT4 + Hamming(7,4) SEC
        "int4_golay",         # INT4 + Golay(24,12) TEC
        "int4_golay_hybrid",  # Hybrid Golay+Hamming
    ]
    ...
    def get_kv_cache_stride_order(
        ...
        Args:
            ...
            cache_dtype_str: The cache dtype string (e.g., "auto", "fp8",
                "int4_golay_hybrid"). Some backends may need this to determine
                the appropriate stride order for specialized cache layouts.
