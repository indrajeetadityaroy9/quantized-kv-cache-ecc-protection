...
class GPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def get_kv_cache_tensors(self) -> list[torch.Tensor]:
        """Return KV cache tensors for fault injection and evaluation.

        Returns:
            List of KV cache tensors, one per layer. Each tensor contains
            both key and value caches in a combined format.
        """
